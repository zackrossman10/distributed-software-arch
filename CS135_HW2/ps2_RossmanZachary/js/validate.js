...
var validateField = function(fieldElem, infoMessage, validateFn) {
  ...
  $(fieldElem).focusout( function (){
    ...
    if(fieldElem.val() === ""){
      ...
      //if form valida tes, text = ok, class = ok, and visible
      if(validateFn(fieldElem)){
